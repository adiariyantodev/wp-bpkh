...
class __TwigTemplate_6e415ca4c440d2ad450caadc94392634d29983e01586e4baf543a08afb44fcc8 extends Template
{
    private $source;
    private $macros = [];
  ...
  if (popupInstance) {
    popupInstance.init({
      closeOnClickOutside: ";
        // line 8
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "popup", [], "any", false, false, false, 8), "popup_can_t_be_closed", [], "any", false, false, false, 8), 1))) ? ("false") : ("true"));
        echo ",
      closeOnEscapeKey: ";
        // line 9
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "popup", [], "any", false, false, false, 9), "popup_can_t_be_closed", [], "any", false, false, false, 9), 1))) ? ("false") : ("true"));
        echo ",
      ...
      disableScrollWhenOpen: ";
        // line 12
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "popup", [], "any", false, false, false, 12), "allow_scroll", [], "any", false, false, false, 12), 1))) ? ("false") : ("true"));
        echo ",
      ";
        // line 13
