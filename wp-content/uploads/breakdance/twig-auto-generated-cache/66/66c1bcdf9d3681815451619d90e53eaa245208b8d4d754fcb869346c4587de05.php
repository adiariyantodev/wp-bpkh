...
class __TwigTemplate_f231650f84d094fe838a1300507f8adba3345a3152b8cd8b2d951b9f75f038ac extends Template
{
    private $source;
    private $macros = [];
...
%%SELECTOR%% .bde-social-icons__icon-wrapper {
  ";
        // line 13
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "icons", [], "any", false, false, false, 13), "shape", [], "any", false, false, false, 13), "100%"))) {
            // line 14
            echo "    border-radius: ";
...
($context["design"] ?? null), "icons", [], "any", false, false, false, 16), "shape", [], "any", false, false, false, 16), "0"))) {
    ...
    background-color: ";
            ...
            echo ";
  ";
        } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 19
($context["design"] ?? null), "icons", [], "any", false, false, false, 19), "shape", [], "any", false, false, false, 19), "custom"))) {
    ...
    background-color: ";
            ...
            echo ";
  ";
        } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 22
